...
echo "
    <form id='formulario-de-troco'>
        <p>Entre com o valor de pagamento (R$):</p>
        <p>
            <input type='number' step='0.50' name='valorDoTroco' value='0,00'>
            <input type='hidden' name='idDaMesa' value='{$mesaId}'>
            <input type='hidden' name='idDaEmpresa' value='{$idEmpresa}'>
        </p>
        <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Fechar</button>
        <button type='button' class='btn btn-primary botao-fazer-troco' data-form-id='formulario-de-troco'>Adicionar Troco</button>
    </form>
";
